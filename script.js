...
async function fetch_Data() {
    let sdata = await fetch("http://localhost:3000/Hospital");
  ...
  function mydelete(id) {
    fetch(`http://localhost:3000/Hospital/${id}`, {
      method: 'DELETE'
    })
  ...
  async function myedit(id){
      ...
      let r=await fetch(`http://localhost:3000/Hospital/${id}`)
      let d=await r.json()
      ...
      <form action="" class="form" >
                      ...
                      <div class="btn">
                      <button type="submit" onclick="finalupdate('${d.id}')">Update Data</button>
                      </div>
                  </form>
